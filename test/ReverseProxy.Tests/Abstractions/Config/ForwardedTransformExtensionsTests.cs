...
namespace Microsoft.ReverseProxy.Abstractions.Config
{
    public class ForwardedTransformExtensionsTests : TransformExtentionsTestsBase
    {
        ...
        [Theory]
        [InlineData(NodeFormat.RandomIp, true, true, NodeFormat.RandomIp, true)]
        [InlineData(NodeFormat.RandomIpAndPort, true, true, NodeFormat.RandomIp, false)]
        [InlineData(NodeFormat.None, false, false, NodeFormat.None, true)]
        [InlineData(NodeFormat.None, false, false, NodeFormat.None, false)]
        [InlineData(NodeFormat.None, false, true, NodeFormat.RandomIp, true)]
        [InlineData(NodeFormat.None, false, true, NodeFormat.RandomIp, false)]
        [InlineData(NodeFormat.None, false, true, NodeFormat.None, false)]
        [InlineData(NodeFormat.None, false, true, NodeFormat.RandomIpAndPort, false)]
