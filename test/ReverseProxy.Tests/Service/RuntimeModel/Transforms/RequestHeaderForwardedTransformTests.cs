...
namespace Microsoft.ReverseProxy.Service.RuntimeModel.Transforms
{
    public class RequestHeaderForwardedTransformTests
    {
        ...
        [InlineData("", "::1", 2, NodeFormat.RandomIp, false, "for=_abcdefghi")]
        [InlineData("", "::1", 2, NodeFormat.RandomIpAndPort, true, "for=\"_abcdefghi:2\"")]
        [InlineData("", "::1", 2, NodeFormat.RandomIpAndRandomPort, true, "for=\"_abcdefghi:_jklmnopqr\"")]
        [InlineData("existing,header", "::1", 2, NodeFormat.RandomIp, false, "for=_abcdefghi")]
        [InlineData("existing,header", "::1", 2, NodeFormat.RandomIpAndPort, true, "existing,header|for=\"_abcdefghi:2\"")]
        [InlineData("existing|header", "::1", 2, NodeFormat.RandomIpAndPort, true, "existing|header|for=\"_abcdefghi:2\"")]
        [InlineData("existing,header", "::1", 2, NodeFormat.RandomIpAndRandomPort, true, "existing,header|for=\"_abcdefghi:_jklmnopqr\"")]
        [InlineData("existing|header", "::1", 2, NodeFormat.RandomIpAndRandomPort, true, "existing|header|for=\"_abcdefghi:_jklmnopqr\"")]
        ...
        [InlineData("", "::1", 2, NodeFormat.RandomIp, false, "by=_abcdefghi")]
        [InlineData("", "::1", 2, NodeFormat.RandomIpAndPort, true, "by=\"_abcdefghi:2\"")]
        [InlineData("", "::1", 2, NodeFormat.RandomIpAndRandomPort, true, "by=\"_abcdefghi:_jklmnopqr\"")]
        [InlineData("existing,header", "::1", 2, NodeFormat.RandomIp, false, "by=_abcdefghi")]
        [InlineData("existing,header", "::1", 2, NodeFormat.RandomIpAndPort, true, "existing,header|by=\"_abcdefghi:2\"")]
        [InlineData("existing|header", "::1", 2, NodeFormat.RandomIpAndPort, true, "existing|header|by=\"_abcdefghi:2\"")]
        [InlineData("existing,header", "::1", 2, NodeFormat.RandomIpAndRandomPort, true, "existing,header|by=\"_abcdefghi:_jklmnopqr\"")]
        [InlineData("existing|header", "::1", 2, NodeFormat.RandomIpAndRandomPort, true, "existing|header|by=\"_abcdefghi:_jklmnopqr\"")]
